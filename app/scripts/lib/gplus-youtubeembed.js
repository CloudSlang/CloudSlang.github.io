...
function LoadYoutubeVidOnPreviewClick(id) {
    var code=   '<div class="embed-responsive embed-responsive-16by9">' +
                    '<iframe src="https://www.youtube.com/embed/'+id+'/?autoplay=1&autohide=1&border=0&wmode=opaque&enablejsapi=1&fs=1" frameborder=0 webkitallowfullscreen mozallowfullscreen allowfullscreen" ></iframe>' +
                '</div>';

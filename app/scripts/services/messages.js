...
angular.module('cloudSlangWebsiteApp')
    .factory('MessagesService', function ($rootScope) {
        ...
        $rootScope.messages = {
            ...
            downloadTextDeb: '.Deb',
            downloadTextDmg: '.Dmg',
            downloadTextGZip: '.GZip',
            downloadTextWindows: 'for Windows',
            downloadTextRHEL: 'for Red Hat',
            downloadTextDebian: 'for Debian',
            downloadTextMac: 'for Mac',
            downloadTextMix: 'for Linux/Mac',
            downloadTextMd5: 'Download .md5 files to check the .rpm and .deb packages',
            cloudSlangVersion: 'CloudSlang version 1.0.7',
